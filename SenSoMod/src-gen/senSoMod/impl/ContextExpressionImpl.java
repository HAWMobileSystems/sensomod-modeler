 ...
 * </p>
 * <ul>
 *   <li>{@link senSoMod.impl.ContextExpressionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextExpressionImpl extends MinimalEObjectImpl.Container implements ContextExpression {
	...
	protected EClass eStaticClass() {
		return SenSoModPackage.Literals.CONTEXT_EXPRESSION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SenSoModPackage.CONTEXT_EXPRESSION__NAME, oldName,
					name));
	}
